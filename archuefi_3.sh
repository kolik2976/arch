...
if [[ $prog_set == 1 ]]; then
  ...
  sudo pacman -S recoll chromium flameshot obs-studio veracrypt vlc freemind filezilla kdenlive neofetch qbittorrent galculator telegram-desktop viewnior --noconfirm
  yay -Syy
